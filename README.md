## FIEL CONVERSOR - Pequeno e simples, mas poderoso! - Versão para Linux e Windows
...
2. Rode:
   ...
   ```
3. Crie uma pasta Tesseract e copie nela os binários e executáveis do tesseract.
